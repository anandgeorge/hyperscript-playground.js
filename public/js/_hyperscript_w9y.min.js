!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e || self)._hyperscript = t()
}(this, function() {
    function e(e, t) {
    ...
    var p,
        ...
        h = function(e) {
            ...
            var r = n.prototype;
            return r.contains = function(e) {
                for (var t, n = l(this); !(t = n()).done;)
                    if (t.value.contains(e))
                        return !0;
                return !1
            }, r[e] = function() {
        ...
        v = function() {
            ...
            function s(e, t, n) {
                ...
                function u(e, t, n, r) {
                    if (m() && m().type && [e, t, n, r].indexOf(m().type) >= 0)
                        return l()
                }
                function s(e, t) {
                    if (-1 === p.indexOf(e))
                ...
                function c(n, r) {
                    for (var i = [], a = f(0, !0); !(null != r && a.type === r || null != n && a.value === n || "EOF" === a.type);) {
                        var u = e.shift();
                        t.push(u),
                        i.push(a),
                        a = f(0, !0)
            ...
            function l(e) {
                if (e.length > 0) {
                    var t = e[e.length - 1];
                    if ("IDENTIFIER" === t.type || "CLASS_REF" === t.type || "ID_REF" === t.type)
                        return !1;
            ...
            return {
                tokenize: function(c, f) {
                    ...
                    function w() {
                        for (var e = g("ATTRIBUTE_REF"), t = P(); h < d.length && "]" !== R();)
                            t += P();
                        return "]" === R() && (t += P()), e.value = t, e.end = h, e
                    }
                    function q() {
                        for (var e = g("ATTRIBUTE_REF"), t = P(); n(R());)
                            t += P();
                        return e.value = t, e.end = h, e
                    }
                    function S() {
                        for (var e = g("STYLE_REF"), t = P(); a(R()) || "-" === R();)
                            t += P();
                        return e.value = t, e.end = h, e
                    }
                    function N() {
                    ...
                    function L() {
                        for (var e = g("IDENTIFIER"), t = P(); a(R()) || i(R()) || u(R());)
                            t += P();
                        return "!" === R() && "beep" === t && (t += P()), e.value = t, e.end = h, e
                    }
                    function C() {
                        for (var e = g("NUMBER"), t = P(); i(R());)
                            t += P();
                        for ("." === R() && i(A()) && (t += P()); i(R());)
                            t += P();
                        return e.value = t, e.end = h, e
                    ...
                    function O() {
                        for (var t = (r = void 0, (r = g(void 0, void 0)).op = !0, r), n = P(); R() && e[n + R()];)
                            n += P();
                        var r;
                        return t.type = e[n], t.value = n, t.end = h, t
                    }
                    function I() {
                        for (var e, t = g("STRING"), n = P(), r = ""; R() && R() !== n;)
                            if ("\\" === R()) {
                                P();
                                var o = P();
                                r += "b" === o ? "\b" : "f" === o ? "\f" : "n" === o ? "\n" : "r" === o ? "\r" : "t" === o ? "\t" : "v" === o ? "\v" : o
                                ...
                                r += P();
                        if (R() !== n)
                            throw Error("Unterminated string at [Line: " + (e = t).line + ", Column: " + e.column + "]");
                        return P(), t.value = r, t.end = h, t.template = "`" === n, t
                    }
                    function R() {
                        return d.charAt(h)
                    }
                    ...
                    function _() {
                        for (var e = g("WHITESPACE"), t = ""; R() && r(R());)
                            o(R()) && (v = 0, y++),
                            t += P();
                        return e.value = t, e.end = h, e
                    }
        ...
        y = function() {
            ...
            function i(e, t, n) {
                e.startToken = t,
                e.sourceFor = n.sourceFor,
                e.lineFor = n.lineFor,
                e.programSource = n.source
            }
            function a(t, n, r) {
                return void 0 === r && (r = void 0), function(r) {
                    var o = e[t];
                    if (o) {
            ...
            return l("feature", function(e, t, r) {
                if (r.matchOpToken("(")) {
                ...
                return a ? i = a(e, n, r) : "IDENTIFIER" === r.currentToken().type && (i = e.parseElement("pseudoCommand", r)), i ? e.parseElement("indirectStatement", r, i) : i
                ...
                if (r)
                    return e.parseElement("indirectExpression", n, r);
                e.raiseParseError(n, "Unexpected value: " + n.currentToken().value)
            }), {
                setParent: function e(t, n) {
                    "object" == typeof t && (t.parent = n, "object" == typeof n && (n.children = n.children || new Set, n.children.add(t)), e(t.next, n))
                },
                requireElement: u,
                parseElement: a,
                featureStart: m,
                ...
                commandBoundary: function(e) {
                    return !("end" != e.value && "then" != e.value && "else" != e.value && "otherwise" != e.value && ")" != e.value && !f(e) && !m(e) && "EOF" != e.type)
                },
                parseAnyOf: s,
                ...
                addCommand: function(n, r) {
                    var o = n + "Command",
                        i = function(e, t, n) {
                            var i = r(e, t, n);
                            if (i)
                                return i.type = o, i.execute = function(e) {
                ...
                addFeature: function(t, r) {
                    var o = t + "Feature",
                        i = function(e, n, i) {
                            var a = r(e, n, i);
                            if (a)
                                return a.isFeature = !0, a.keyword = t, a.type = o, a
                        };
                    e[o] = i,
                    n[t] = i
                },
        ...
        T = function() {
            ...
            function t(e, t, n, r) {
                ...
                var o = function(e, t) {
                    var n;
                    return d.Event && "function" == typeof d.Event ? (n = new Event(e, {
                        bubbles: !0,
                        cancelable: !0
                    })).detail = t : (n = document.createEvent("CustomEvent")).initCustomEvent(e, !0, !0, t), n
                }(t, n);
                return e.dispatchEvent(o)
            }
            function r(e) {
                return Array.isArray(e) || "undefined" != typeof NodeList && (e instanceof NodeList || e instanceof HTMLCollection)
            }
            function o(e) {
                    ...
                    for (var i = 0; i < e.args.length; i++) {
                        ...
                        if (null == u)
                            ...
                            for (var s = [], l = 0; l < u.length; l++) {
                                var c = u[l];
                                (f = c ? c.evaluate(t) : null) && (f.then ? r = !0 : f.asyncWrapper && (o = !0)),
                                s.push(f)
                            }
                            n.push(s)
                        } else if (u.evaluate) {
                            var f;
                            (f = u.evaluate(t)) && (f.then ? r = !0 : f.asyncWrapper && (o = !0)),
                            n.push(f)
                        } else
                            n.push(u)
                    }
            ...
            function x(e) {
                for (var t = 0; t < g().length; t++) {
                    var n = g()[t];
                    if (e.hasAttribute && e.hasAttribute(n))
            ...
            return {
                ...
                processNode: function(t) {
                    ...
                    e(t, n) && L(t, t),
                    t instanceof HTMLScriptElement && "text/hyperscript" === t.type && L(t, document.body),
                    t.querySelectorAll && i(t.querySelectorAll(n + ", [type='text/hyperscript']"), function(e) {
                        L(e, e instanceof HTMLScriptElement && "text/hyperscript" === e.type ? document.body : e)
                    })
                },
                ...
                evaluateNoPromise: function(e, t) {
                    var n = e.evaluate(t);
                    if (n.next)
                        throw new Error(e.sourceFor() + " returned a Promise in a context that they are not allowed.");
                    return n
                },
                parse: N,
                ...
                resolveSymbol: function(e, t, n) {
                    ...
                    var o = t[e];
                    return void 0 !== o || void 0 !== (o = I(t)[e]) ? o : d[e]
                },
                setSymbol: function(e, t, n, r) {
                    if ("global" === n)
                        ...
                        var o,
                            i = t[e];
                        void 0 !== i ? t[e] = r : void 0 !== (i = (o = I(t))[e]) ? o[e] = r : t[e] = r
                    }
                },
                makeContext: S,
                findNext: function e(t, n) {
                    if (t)
                        return t.resolveNext ? t.resolveNext(n) : t.next ? t.next : e(t.parent, n)
                },
                unifiedEval: m,
                ...
                unifiedExec: function e(t, n) {
                    for (;;) {
                        try {
                            ...
                            if (n.meta.handlingFinally)
                                console.error(" Exception in finally block: ", e),
                                r = s;
                            else {
                                if (T.registerHyperTrace(n, e), n.meta.errorHandler && !n.meta.handlingError) {
                                    n.meta.handlingError = !0,
                                    n[n.meta.errorSymbol] = e,
                                    t = n.meta.errorHandler;
                                    continue
                                }
                                n.meta.currentException = e,
                                r = s
                            }
                        }
                        if (null == r)
                            return void console.error(t, " did not return a next element to execute! context: ", n);
                        if (r.then)
                            return void r.then(function(t) {
                                e(t, n)
                            }).catch(function(t) {
                                e({
                                    op: function() {
                        ...
                        if (r === s) {
                            if (!n.meta.finallyHandler || n.meta.handlingFinally) {
                                if (n.meta.onHalt && n.meta.onHalt(), n.meta.currentException) {
                                    if (n.meta.reject)
                                        return void n.meta.reject(n.meta.currentException);
                                    throw n.meta.currentException
                                }
                                return
                            }
                            n.meta.handlingFinally = !0,
                            t = n.meta.finallyHandler
                        } else
                            t = r
                    }
                },
                ...
                registerHyperTrace: function(e, t) {
                    for (var n = [], r = null; null != e;)
                        n.push(e),
                        r = e,
                        e = e.meta.caller;
                    null == r.meta.traceMap && (r.meta.traceMap = new Map),
                    r.meta.traceMap.get(t) || r.meta.traceMap.set(t, {
                        trace: n,
                        print: function(e) {
                            (e = e || console.error)("hypertrace /// ");
                            for (var t = 0, r = 0; r < n.length; r++)
                                t = Math.max(t, n[r].meta.feature.displayName.length);
                ...
                getHyperTrace: function(e, t) {
                    for (var n = e; n.meta.caller;)
                        n = n.meta.caller;
                    if (n.meta.traceMap)
                        return n.meta.traceMap.get(t, [])
                },
                getInternalData: O,
                ...
                getEventQueueFor: function(e, t) {
                    ...
                    var o = r.get(t);
                    return null == o && r.set(t, o = {
                        queue: [],
                        executing: !1
                    }), o
                },
                hyperscriptUrl: "document" in d ? "undefined" == typeof document && "undefined" == typeof location ? new (require("url").URL)("file:" + __filename).href : "undefined" == typeof document ? location.href : document.currentScript && document.currentScript.src || new URL("_hyperscript_w9y.min.js", document.baseURI).href : null,
                HALT: s
            }
        }(),
        k = function(e, t, n) {
        ...
        x = function(e, t, n, r) {
            ...
            if ("send" === e && r.matchToken("to") || "trigger" === e && r.matchToken("on"))
                ...
                a = t.requireElement("implicitMeTarget", r);
            var u = {
                eventName: o,
                details: i,
                to: a,
                args: [a, o, i],
                op: function(e, t, r, o) {
                    return n.nullCheck(t, a), n.forEach(t, function(t) {
        ...
        b = function(e, t) {
            var n,
                r = "text";
            return e.matchToken("a") || e.matchToken("an"), e.matchToken("json") || e.matchToken("Object") ? r = "json" : e.matchToken("response") ? r = "response" : e.matchToken("html") ? r = "html" : e.matchToken("text") || (n = t.requireElement("dotOrColonPath", e).evaluate()), {
                type: r,
                conversion: n
            }
        };
    ...
    y.addGrammarElement("nakedString", function(e, t, n) {
        if (n.hasMore()) {
            ...
            return n.matchTokenType("WHITESPACE"), {
                type: "nakedString",
                tokens: r,
                evaluate: function(e) {
    ...
    var w = function(e, r) {
        function o(t, n, r) {
            var o;
            return (o = e.call(this, t, n) || this).templateParts = r, o.elements = r.filter(function(e) {
                return e instanceof Element
            }), o
        }
        return n(o, e), o.prototype[r] = function() {
    ...
    y.addLeafExpression("attributeRef", function(e, t, n) {
        ...
        if (r) {
            var o = r.value;
            if (0 === o.indexOf("["))
                var i = o.substring(2, o.length - 1);
            else
                i = o.substring(1);
            var a = "[" + i + "]",
                u = i.split("="),
                s = u[0],
                l = u[1];
            return l && 0 === l.indexOf('"') && (l = l.substring(1, l.length - 1)), {
                type: "attributeRef",
                name: s,
                css: a,
                value: l,
        ...
        if (r) {
            ...
            return o.startsWith("computed-") ? {
                ...
                op: function(e) {
                    ...
                    if (n)
                        return t.resolveComputedStyle(n, o)
                },
                evaluate: function(e) {
                    return t.unifiedEval(this, e)
                }
    ...
    y.addGrammarElement("symbol", function(e, t, n) {
        var r = "default";
        n.matchToken("global") ? r = "global" : n.matchToken("element") || n.matchToken("module") ? (r = "element", n.matchOpToken("'") && n.requireToken("s")) : n.matchToken("local") && (r = "local");
        var o = n.matchOpToken(":"),
            i = n.matchTokenType("IDENTIFIER");
        if (i) {
            var a = i.value;
            return o && (a = ":" + a), "default" === r && (0 === a.indexOf("$") && (r = "global"), 0 === a.indexOf(":") && (r = "element")), {
                type: "symbol",
                token: i,
                scope: r,
                name: a,
    ...
    y.addLeafExpression("blockLiteral", function(e, t, n) {
        if (n.matchOpToken("\\")) {
            ...
            if (o)
                for (r.push(o); n.matchOpToken(",");)
                    r.push(n.requireTokenType("IDENTIFIER"));
            n.requireOpToken("-"),
            n.requireOpToken(">");
    ...
    y.addIndirectExpression("of", function(e, t, n, r) {
        if (n.matchToken("of")) {
            for (var o = e.requireElement("unaryExpression", n), i = null, a = r; a.root;)
                i = a,
                a = a.root;
            "symbol" !== a.type && "attributeRef" !== a.type && "styleRef" !== a.type && "computedStyleRef" !== a.type && e.raiseParseError(n, "Cannot take a property of a non-symbol: " + a.type);
            ...
            var c = a.name,
                f = {
                    ...
                    args: [o],
                    op: function(e, n) {
                        return u ? t.resolveAttribute(n, c) : s ? "computedStyleRef" === a.type ? t.resolveComputedStyle(n, c) : t.resolveStyle(n, c) : t.resolveProperty(n, c)
                    },
                    evaluate: function(e) {
                        return t.unifiedEval(this, e)
                    }
                };
            return "attributeRef" === a.type && (f.attribute = a), i ? (i.root = f, i.args = [f]) : r = f, e.parseElement("indirectExpression", n, r)
        }
    }),
    y.addIndirectExpression("possessive", function(e, t, n, r) {
        if (!e.possessivesDisabled) {
            var o = n.matchOpToken("'");
            if (o || "symbol" === r.type && ("my" === r.name || "its" === r.name || "your" === r.name) && ("IDENTIFIER" === n.currentToken().type || "ATTRIBUTE_REF" === n.currentToken().type || "STYLE_REF" === n.currentToken().type)) {
                o && n.requireToken("s");
                var i = e.parseElement("attributeRef", n);
                if (null == i) {
                    var a = e.parseElement("styleRef", n);
                    if (null == a)
                        var u = n.requireTokenType("IDENTIFIER")
                }
                return e.parseElement("indirectExpression", n, {
                    type: "possessive",
                    root: r,
                    ...
                    op: function(e, n) {
                        if (i)
                            var r = t.resolveAttribute(n, i.name);
                        else
                            r = a ? "computedStyleRef" === a.type ? t.resolveComputedStyle(n, a.name) : t.resolveStyle(n, a.name) : t.resolveProperty(n, u.value);
                        return r
                    },
                    evaluate: function(e) {
                        return t.unifiedEval(this, e)
    ...
    y.addIndirectExpression("inExpression", function(e, t, n, r) {
        if (n.matchToken("in")) {
            var o = {
                type: "inExpression",
                root: r,
                args: [r, e.requireElement("unaryExpression", n)],
                op: function(e, n, r) {
                    var o = [];
                    if (n.css)
                        t.implicitLoop(r, function(e) {
                            for (var t = e.querySelectorAll(n.css), r = 0; r < t.length; r++)
                                o.push(t[r])
                        });
                    else if (n instanceof Element) {
                        var i = !1;
                        if (t.implicitLoop(r, function(e) {
                            e.contains(n) && (i = !0)
                        }), i)
                            return n
                    } else
    ...
    y.addIndirectExpression("arrayIndex", function(e, t, n, r) {
        if (n.matchOpToken("[")) {
            var o = !1,
                ...
                a = null,
                u = null;
            n.matchOpToken("..") ? (o = !0, a = e.requireElement("expression", n)) : (a = e.requireElement("expression", n), n.matchOpToken("..") && (i = !0, "R_BRACKET" !== n.currentToken().type && (u = e.parseElement("expression", n)))),
            n.requireOpToken("]");
            var s = {
                type: "arrayIndex",
                root: r,
                ...
                args: [r, a, u],
                op: function(e, t, n, r) {
                    return null == t ? null : o ? (n < 0 && (n = t.length + n), t.slice(0, n + 1)) : i ? null != r ? (r < 0 && (r = t.length + r), t.slice(n, r + 1)) : t.slice(n) : t[n]
                },
                evaluate: function(e) {
                    return T.unifiedEval(this, e)
                }
    ...
    var q = ["em", "ex", "cap", "ch", "ic", "rem", "lh", "rlh", "vw", "vh", "vi", "vb", "vmin", "vmax", "cm", "mm", "Q", "pc", "pt", "px"];
    y.addGrammarElement("postfixExpression", function(e, t, n) {
        ...
        var i = null;
        if (n.matchToken("s") || n.matchToken("seconds") ? i = 1e3 : (n.matchToken("ms") || n.matchToken("milliseconds")) && (i = 1), i)
            return {
                type: "timeExpression",
                time: r,
                factor: i,
    ...
    y.addGrammarElement("unaryExpression", function(e, t, n) {
        return n.matchToken("the"), e.parseAnyOf(["beepExpression", "logicalNot", "relativePositionalExpression", "positionalExpression", "noExpression", "negativeNumber", "postfixExpression"], n)
    }),
    y.addGrammarElement("beepExpression", function(e, t, n) {
        if (n.matchToken("beep!")) {
            var r = e.parseElement("unaryExpression", n);
            if (r) {
                r.booped = !0;
                var o = r.evaluate;
                return r.evaluate = function(e) {
                    var n = o.apply(r, arguments),
                        i = e.me;
                    if (t.triggerEvent(i, "hyperscript:beep", {
                        element: i,
                        expression: r,
                        value: n
                    })) {
                        var a,
                            u = n;
                        "String" === (a = n ? n instanceof h ? "ElementCollection" : n.constructor ? n.constructor.name : "unknown" : "object (null)") ? u = '"' + u + '"' : n instanceof h && (u = Array.from(n)),
                        console.log("///_ BEEP! The expression (" + r.sourceFor().substr(6) + ") evaluates to:", u, "of type " + a)
                    }
                    return n
                }, r
            }
    ...
    y.addGrammarElement("relativePositionalExpression", function(e, t, n) {
        ...
        if (r) {
            ...
            if (n.matchToken("from")) {
                n.pushFollow("in");
                try {
                    var a = e.requireElement("unaryExpression", n)
                } finally {
                    n.popFollow()
                }
            } else
                a = e.requireElement("implicitMeTarget", n);
            var u,
                s = !1;
            if (n.matchToken("in")) {
                s = !0;
                var l = e.requireElement("unaryExpression", n)
            } else
                u = n.matchToken("within") ? e.requireElement("unaryExpression", n) : document.body;
            var c = !1;
            return n.matchToken("with") && (n.requireToken("wrapping"), c = !0), {
                ...
                op: function(e, t, n, r, i) {
                    ...
                    if (s) {
                        if (r)
                            return o ? S(n, r, l, c) : (a = l, u = c, S(n, Array.from(r).reverse(), a, u))
                    } else if (i)
    ...
    y.addGrammarElement("mathOperator", function(e, t, n) {
        ...
        for (r = n.matchAnyOpToken("+", "-", "*", "/", "%"); r;) {
            var a = r.value;
            (i = i || r).value !== a && e.raiseParseError(n, "You must parenthesize math operations with different operators");
            ...
            o = {
                ...
                args: [o, u],
                op: function(e, t, n) {
                    return "+" === a ? t + n : "-" === a ? t - n : "*" === a ? t * n : "/" === a ? t / n : "%" === a ? t % n : void 0
                },
                evaluate: function(e) {
                    return t.unifiedEval(this, e)
                }
    ...
    y.addGrammarElement("comparisonOperator", function(e, t, n) {
        var r = e.parseElement("mathExpression", n),
            ...
            a = !0,
            u = !1;
        if (null == i && (n.matchToken("is") || n.matchToken("am") ? n.matchToken("not") ? n.matchToken("in") ? i = "not in" : n.matchToken("a") ? (i = "not a", u = !0) : n.matchToken("empty") ? (i = "not empty", a = !1) : i = "!=" : n.matchToken("in") ? i = "in" : n.matchToken("a") ? (i = "a", u = !0) : n.matchToken("empty") ? (i = "empty", a = !1) : n.matchToken("less") ? (n.requireToken("than"), n.matchToken("or") ? (n.requireToken("equal"), n.requireToken("to"), i = "<=") : i = "<") : n.matchToken("greater") ? (n.requireToken("than"), n.matchToken("or") ? (n.requireToken("equal"), n.requireToken("to"), i = ">=") : i = ">") : i = "==" : n.matchToken("exist") || n.matchToken("exists") ? (i = "exist", a = !1) : n.matchToken("matches") || n.matchToken("match") ? i = "match" : n.matchToken("contains") || n.matchToken("contain") ? i = "contain" : n.matchToken("includes") || n.matchToken("include") ? i = "include" : (n.matchToken("do") || n.matchToken("does")) && (n.requireToken("not"), n.matchToken("matches") || n.matchToken("match") ? i = "not match" : n.matchToken("contains") || n.matchToken("contain") ? i = "not contain" : n.matchToken("exist") || n.matchToken("exist") ? (i = "not exist", a = !1) : n.matchToken("include") ? i = "not include" : e.raiseParseError(n, "Expected matches or contains"))), i) {
            if (u)
            ...
            r = {
                ...
                op: function(e, n, r) {
                    ...
                    if ("!=" === i)
                        return n != r;
                    if ("match" === i)
                        return null != n && g(f, n, r);
                    if ("not match" === i)
                        return null == n || !g(f, n, r);
                    if ("in" === i)
                        return null != r && k(c, r, n);
                    if ("not in" === i)
                        return null == r || !k(c, r, n);
                    if ("contain" === i)
                        return null != n && k(f, n, r);
                    if ("not contain" === i)
                        return null == n || !k(f, n, r);
                    if ("include" === i)
                        return null != n && k(f, n, r);
                    ...
                    if ("not empty" === i)
                        return !t.isEmpty(n);
                    if ("exist" === i)
                        return t.doesExist(n);
                    if ("not exist" === i)
                        return !t.doesExist(n);
                    if ("a" === i)
                        return t.typeCheck(n, s.value, l);
                    if ("not a" === i)
                        return !t.typeCheck(n, s.value, l);
    ...
    y.addGrammarElement("logicalOperator", function(e, t, n) {
        ...
        for (var a = function() {
            (i = i || r).value !== r.value && e.raiseParseError(n, "You must parenthesize logical operations with different operators"),
    ...
    y.addGrammarElement("assignableExpression", function(e, t, n) {
        n.matchToken("the");
        var r = e.parseElement("primaryExpression", n);
        return !r || "symbol" !== r.type && "ofExpression" !== r.type && "propertyAccess" !== r.type && "attributeRefAccess" !== r.type && "attributeRef" !== r.type && "styleRef" !== r.type && "arrayIndex" !== r.type && "possessive" !== r.type ? (y.raiseParseError(n, "A target expression must be writable.  The expression type '" + (r && r.type) + "' is not."), r) : r
    }),
    y.addGrammarElement("hyperscript", function(e, t, n) {
        ...
        return {
            ...
            apply: function(e, t, n) {
                for (var o, i = l(r); !(o = i()).done;)
                    o.value.install(e, t, n)
            }
        }
    });
    var N = function(e) {
    ...
    y.addFeature("on", function(e, t, n) {
        if (n.matchToken("on")) {
            ...
            do {
                ...
                var u = N(n),
                    s = null;
                if (n.matchOpToken("[") && (s = e.requireElement("expression", n), n.requireOpToken("]")), "NUMBER" === n.currentToken().type) {
                ...
                if ("intersection" === a) {
                    ...
                    if (n.matchToken("with") && (v.with = e.requireElement("expression", n).evaluate()), n.matchToken("having"))
                        do {
                            n.matchToken("margin") ? v.rootMargin = e.requireElement("stringLike", n).evaluate() : n.matchToken("threshold") ? v.threshold = e.requireElement("expression", n).evaluate() : e.raiseParseError(n, "Unknown intersection config specification")
                    ...
                    if (n.matchToken("of"))
                        do {
                            if (n.matchToken("anything"))
                                ...
                                y.characterData = !0,
                                y.childList = !0;
                            else if (n.matchToken("childList"))
                                y.childList = !0;
                            else if (n.matchToken("attributes"))
                                y.attributes = !0,
                                y.attributeOldValue = !0;
                            else if (n.matchToken("subtree"))
                                y.subtree = !0;
                            else if (n.matchToken("characterData"))
                                y.characterData = !0,
                                y.characterDataOldValue = !0;
                            else if ("ATTRIBUTE_REF" === n.currentToken().type) {
                                var E = n.consumeToken();
                                null == y.attributeFilter && (y.attributeFilter = []),
                                0 == E.value.indexOf("@") ? y.attributeFilter.push(E.value.substring(1)) : e.raiseParseError(n, "Only shorthand attribute references are allowed here")
                            } else
                                e.raiseParseError(n, "Unknown mutation config specification")
                ...
                var k = null,
                    g = !1;
                if (n.matchToken("from") && (n.matchToken("elsewhere") ? g = !0 : (k = e.parseElement("expression", n)) || e.raiseParseError(n, 'Expected either target value or "elsewhere".')), null === k && !1 === g && n.matchToken("elsewhere") && (g = !0), n.matchToken("in"))
                    var x = e.parseElement("unaryExpression", n);
            ...
            if (!r && n.matchToken("queue"))
                if (n.matchToken("all"))
                    q = !1;
                else if (n.matchToken("first"))
                    var S = !0;
                else if (n.matchToken("none"))
                    var L = !0;
                else
                    n.requireToken("last");
            var C = e.requireElement("commandList", n);
            if (e.ensureTerminated(C), n.matchToken("catch")) {
                ...
                install: function(e, n) {
                    for (var r, o = function() {
                            ...
                            t.implicitLoop(a, function(r) {
                                var o = n.on;
                                if (n.mutationSpec && (o = "hyperscript:mutation", new MutationObserver(function(e, t) {
                                    A.executing || T.triggerEvent(r, o, {
                                        mutationList: e,
                                        observer: t
                                    })
                                }).observe(r, n.mutationSpec)), n.intersectionSpec) {
                                    ...
                                    var i = new IntersectionObserver(function(e) {
                                        for (var t, n = l(e); !(t = n()).done;) {
                                            ...
                                            (u = c(u, a)).intersecting = a.isIntersecting,
                                            T.triggerEvent(r, o, u)
                                        }
                                    }, n.intersectionSpec);
                                    i.observe(r)
                                }
                                    ...
                                    if ("undefined" != typeof Node && e instanceof Node && r !== e && !e.isConnected)
                                        ...
                                        if (!n.elsewhere || !e.contains(a.target)) {
                                            ...
                                            for (var s, c = l(n.args); !(s = c()).done;) {
                                                var f = s.value,
                                                    m = u.event[f.value];
                                                void 0 !== m ? u[f.value] = m : "detail" in u.event && (u[f.value] = u.event.detail[f.value])
                                            }
                                            if (u.meta.errorHandler = I, u.meta.errorSymbol = O, u.meta.finallyHandler = R, n.filter) {
                                                var p = u.meta.context;
                                                u.meta.context = u.event;
                                                try {
                                                    if (!n.filter.evaluate(u))
                                                        return
                                                } finally {
                                                    u.meta.context = p
                                                }
                                            ...
                                            if (n.inExpr)
                                                for (var d = a.target;;) {
                                                    ...
                                                    if (null == (d = d.parentElement))
                                                        return
                                                }
                                            if (n.execCount++, n.startCount)
                                                if (n.endCount) {
                                                    if (n.execCount < n.startCount || n.execCount > n.endCount)
                                                        return
                                                } else if (n.unbounded) {
                                                    if (n.execCount < n.startCount)
                                                        return
                                                } else if (n.execCount !== n.startCount)
                                                    return;
                                            if (n.debounceTime)
                                                return n.debounced && clearTimeout(n.debounced), void (n.debounced = setTimeout(function() {
                                                    A.execute(u)
                                                }, n.debounceTime));
                                            if (n.throttleTime) {
                        ...
                        }, i = l(A.events); !(r = i()).done;) {
                        var a;
                        o()
                    }
                }
            };
            return e.setParent(C, A), A
        }
    }),
    y.addFeature("def", function(e, t, n) {
        if (n.matchToken("def")) {
            ...
            var f = {
                displayName: i + "(" + a.map(function(e) {
                    return e.value
                }).join(", ") + ")",
                name: i,
                args: a,
                ...
                install: function(e, n) {
                    var m = function() {
                        ...
                        r.meta.errorHandler = l,
                        r.meta.errorSymbol = s,
                        r.meta.finallyHandler = c;
                        ...
                        return u.execute(r), r.meta.returned ? r.meta.returnValue : (r.meta.resolve = p, r.meta.reject = d, h)
                    };
                    m.hyperfunc = !0,
                    m.hypername = r,
                    t.assignToNamespace(e, o, i, m)
                }
            };
    ...
    y.addFeature("set", function(e, t, n) {
        ...
        if (r) {
            "element" !== r.target.scope && e.raiseParseError(n, "variables declared at the feature level must be element scoped.");
            var o = {
                start: r,
                install: function(e, n) {
    ...
    y.addFeature("worker", function(e, t, n) {
        n.matchToken("worker") && e.raiseParseError(n, "In order to use the 'worker' feature, include the _hyperscript worker plugin. See https://hyperscript.org/features/worker/ for more info.")
    }),
    y.addFeature("behavior", function(e, t, n) {
        if (n.matchToken("behavior")) {
            ...
            for (var u = e.requireElement("hyperscript", n), s = 0; s < u.features.length; s++)
                u.features[s].behavior = r;
            return {
                install: function(e, n) {
                    t.assignToNamespace(d.document && d.document.body, o, i, function(e, n, o) {
                        for (var i = f(t.getInternalData(e), r + "Scope"), s = 0; s < a.length; s++)
                            i[a[s]] = o[a[s]];
                        u.apply(e, n)
                    })
                }
                    ...
                    t.unifiedEval({
                        ...
                        op: function(t, r) {
                            ...
                            if (!(a instanceof Function))
                                throw new Error(o + " is not a behavior");
                            a(e, n, r)
                        }
                    }, t.makeContext(e, r, e))
                }
    ...
    y.addGrammarElement("jsBody", function(e, t, n) {
        for (var r = n.currentToken().start, o = n.currentToken(), i = [], a = "", u = !1; n.hasMore();) {
            o = n.consumeToken();
            var s = n.token(0, !0);
            if ("IDENTIFIER" === s.type && "end" === s.value)
                break;
            u ? "IDENTIFIER" === o.type || "NUMBER" === o.type ? a += o.value : ("" !== a && i.push(a), a = "", u = !1) : "IDENTIFIER" === o.type && "function" === o.value && (u = !0)
        }
        return {
            type: "jsBody",
            exposedFunctionNames: i,
            jsSource: n.source.substring(r, o.end + 1)
        }
    }),
    y.addFeature("js", function(e, t, n) {
        if (n.matchToken("js")) {
            var r = e.requireElement("jsBody", n),
                o = r.jsSource + "\nreturn { " + r.exposedFunctionNames.map(function(e) {
                    return e + ":" + e
                }).join(",") + " } ",
                i = new Function(o);
            return {
        ...
        if (n.matchToken("js")) {
            ...
            return {
                ...
                op: function(e) {
                    ...
                    var o = a.apply(d, n);
                    return o && "function" == typeof o.then ? new Promise(function(n) {
                        o.then(function(r) {
                            e.result = r,
                            n(t.findNext(this, e))
                        })
    ...
    y.addCommand("async", function(e, t, n) {
        if (n.matchToken("async")) {
            if (n.matchToken("do")) {
                for (var r = o = e.requireElement("commandList", n); r.next;)
                    r = r.next;
                r.next = t.HALT,
                n.requireToken("end")
            } else
                var o = e.requireElement("command", n);
            var i = {
                body: o,
                op: function(e) {
            ...
            var a = "tell_" + r.start,
                u = {
                    ...
                    resolveNext: function(e) {
                        ...
                        return n.index < n.value.length ? (e.beingTold = n.value[n.index++], i) : (e.beingTold = n.originalBeingTold, this.next ? this.next : t.findNext(this.parent, e))
                    },
                    op: function(e, t) {
                        return null == t ? t = [] : Array.isArray(t) || t instanceof NodeList || (t = [t]), e.meta.iterators[a] = {
                            originalBeingTold: e.beingTold,
                            index: 0,
                            value: t
                        }, this.resolveNext(e)
                    }
    ...
    y.addCommand("wait", function(e, t, n) {
        if (n.matchToken("wait")) {
            ...
            if (n.matchToken("for")) {
                ...
                do {
                    var a = n.token(0);
                    i.push("NUMBER" === a.type || "L_PAREN" === a.type ? {
                        time: e.requireElement("expression", n).evaluate()
                    } : {
                        name: y.requireElement("dotOrColonPath", n, "Expected event name").evaluate(),
                        args: N(n)
                    })
                } while (n.matchToken("or"));
                if (n.matchToken("from"))
                    ...
                    op: function(e, n) {
                        ...
                        return new Promise(function(n) {
                            for (var a, u = !1, s = function() {
                                    ...
                                    i.name ? o.addEventListener(i.name, f, {
                                        once: !0
            ...
            return n.matchToken("a") ? (n.requireToken("tick"), o = 0) : o = y.requireElement("expression", n), {
                type: "waitCmd",
                time: o,
                args: [o],
                op: function(e, n) {
    ...
    y.addCommand("trigger", function(e, t, n) {
        if (n.matchToken("trigger"))
            return x("trigger", e, t, n)
    }),
    y.addCommand("send", function(e, t, n) {
        if (n.matchToken("send"))
            return x("send", e, t, n)
    });
    var L = function(e, t, n, r) {
        if (r)
            if (e.commandBoundary(n.currentToken()))
                e.raiseParseError(n, "'return' commands must return a value.  If you do not wish to return a value, use 'exit' instead.");
            else
                var o = e.requireElement("expression", n);
        var i = {
            value: o,
    ...
    y.addCommand("halt", function(e, t, n) {
        if (n.matchToken("halt")) {
            ...
            return {
                ...
                op: function(e) {
                    if (e.event)
                        return o ? e.event.stopPropagation() : (i || e.event.stopPropagation(), e.event.preventDefault()), r ? t.findNext(this, e) : a
                }
            }
        }
    }),
    ...
    y.addCommand("make", function(e, t, n) {
        if (n.matchToken("make")) {
            ...
            if (n.matchToken("called"))
                var a = e.requireElement("symbol", n);
            return "queryRef" === o.type ? r = {
                op: function(e) {
                    ...
                    for (var c = 0; c < u.length; c++)
                        l.classList.add(u[c]);
                    return e.result = l, a && t.setSymbol(a.name, e, a.scope, l), t.findNext(this, e)
                }
            } : (r = {
                args: [o, i],
                op: function(e, n, r) {
                    return e.result = m(n, r), a && t.setSymbol(a.name, e, a.scope, e.result), t.findNext(this, e)
                }
            }, r)
        }
    }),
    y.addGrammarElement("pseudoCommand", function(e, t, n) {
        var r = n.token(1);
        if (!r || !r.op || "." !== r.value && "(" !== r.value)
            return null;
        for (var o = e.requireElement("primaryExpression", n), i = o.root, a = o; null != i.root;)
            a = a.root,
            i = i.root;
        if ("functionCall" !== o.type && e.raiseParseError(n, "Pseudo-commands must be function calls"), "functionCall" === a.type && null == a.root.root)
            if (n.matchAnyToken("the", "to", "on", "with", "into", "from", "at"))
                var u = e.requireElement("expression", n);
            else
                n.matchToken("me") && (u = e.requireElement("implicitMeTarget", n));
        if (u)
            var s = {
                type: "pseudoCommand",
                root: u,
    ...
    var O = function(e, t, n, r, o) {
        ...
        if (i)
            ...
            l = e.requireElement("implicitMeTarget", n);
            var f = r
        } else
            s ? (c = r.firstIndex, l = r.root) : (c = r.prop ? r.prop.value : null, f = r.attribute, l = r.root);
        var m = {
            target: r,
            symbolWrite: i,
            value: o,
            args: [l, c, o],
            op: function(e, n, o, a) {
                return i ? t.setSymbol(r.name, e, r.scope, a) : (t.nullCheck(n, l), s ? n[o] = a : t.implicitLoop(n, function(e) {
                    f ? "attributeRef" === f.type ? null == a ? e.removeAttribute(f.name) : e.setAttribute(f.name, a) : e.style[f.name] = a : e[o] = a
                })), t.findNext(this, e)
            }
        };
        return m
    ...
    y.addCommand("if", function(e, t, n) {
        if (n.matchToken("if")) {
            ...
            n.matchToken("then");
            var o = e.parseElement("commandList", n);
            if (n.matchToken("else") || n.matchToken("otherwise"))
                var i = e.parseElement("commandList", n);
    ...
    var I = function(e, t, n, r) {
        ...
        if (t.matchToken("for") || r) {
            ...
            o = "it",
            u = e.requireElement("expression", t);
            ...
            if (t.matchToken("event")) {
                ...
                s = e.requireElement("expression", t)
        ...
        if (t.matchToken("index"))
            var d = (a = t.requireTokenType("IDENTIFIER")).value;
        ...
        if (t.hasMore() && t.requireToken("end"), null == o)
            var T = o = "_implicit_repeat_" + i.start;
        else
            T = o + "_" + i.start;
        var k = {
            identifier: o,
            ...
            op: function(e, t, r) {
                ...
                if (this.forever)
                    ...
                    a = c ? !1 === e.meta.iterators[T].eventFired : !0 !== t;
                else if (s)
                    a = t;
                else if (r)
                    a = i.index < r;
                ...
                return a ? (e.result = i.value ? e[o] = u : i.index, d && (e[d] = i.index), i.index++, h) : (e.meta.iterators[T] = null, n.findNext(this.parent, e))
            }
        };
        e.setParent(h, k);
        var g = {
            ...
            op: function(e, t, n, r) {
                ...
                return e.meta.iterators[T] = o, t && t[Symbol.iterator] && (o.iterator = t[Symbol.iterator]()), c && (r || e.me).addEventListener(n, function(t) {
    ...
    if (y.addCommand("repeat", function(e, t, n) {
        if (n.matchToken("repeat"))
            return I(e, n, t, !1)
            ...
            return {
                op: function(t) {
                    for (var r = this.parent;; r = r.parent)
                        if (null == r && e.raiseParseError(n, "Command `continue` cannot be used outside of a `repeat` loop."), null != r.loop)
            ...
            return {
                op: function(r) {
                    for (var o = this.parent;; o = o.parent)
                        if (null == o && e.raiseParseError(n, "Command `continue` cannot be used outside of a `repeat` loop."), null != o.loop)
                            return t.findNext(o.parent, r)
                }
            }
        ...
        if (n.matchToken("append")) {
            ...
            var u = {
                ...
                op: function(e, n, r) {
                    if (Array.isArray(n))
                        return n.push(r), t.findNext(this, e);
                    if (n instanceof Element)
                        return n.innerHTML += r, t.findNext(this, e);
                    if (a)
                        return e.result = (n || "") + r, a;
        ...
        if (n.matchToken("fetch")) {
            ...
            if (n.matchToken("as"))
                var o = b(n, e);
            if (n.matchToken("with") && "{" !== n.currentToken().value)
                var i = e.parseElement("nakedNamedArgumentList", n);
            else
                i = e.parseElement("objectLiteral", n);
                ...
                s = {
                    ...
                    op: function(e, n, r) {
                        ...
                        var i = new AbortController,
                            l = e.me.addEventListener("fetch:abort", function() {
                                i.abort()
                            }, {
                                once: !0
                            });
                        ...
                        var c = !1;
                        return (r = o).timeout && setTimeout(function() {
                            c || i.abort()
                        }, r.timeout), fetch(n, r).then(function(n) {
                            var r = {
                                response: n
                            };
                            return t.triggerEvent(e.me, "fetch:afterResponse", r), n = r.response, "response" === a ? (e.result = n, t.triggerEvent(e.me, "fetch:afterRequest", {
                                result: n
                            }), c = !0, t.findNext(s, e)) : "json" === a ? n.json().then(function(n) {
                                return e.result = n, t.triggerEvent(e.me, "fetch:afterRequest", {
                                    result: n
                                }), c = !0, t.findNext(s, e)
                            }) : n.text().then(function(n) {
                                return u && (n = t.convertValue(n, u)), "html" === a && (n = t.convertValue(n, "Fragment")), e.result = n, t.triggerEvent(e.me, "fetch:afterRequest", {
                                    result: n
                                }), c = !0, t.findNext(s, e)
                            })
                        }).catch(function(n) {
                            throw t.triggerEvent(e.me, "fetch:error", {
                                reason: n
                            }), n
                        }).finally(function() {
        ...
        var R = Array.from(document.querySelectorAll("script[type='text/hyperscript'][src]"));
        Promise.all(R.map(function(e) {
            return fetch(e.src).then(function(e) {
                return e.text()
            })
        })).then(function(e) {
            return e.forEach(T.evaluate)
        }).then(function() {
            var e;
            e = function() {
                var e,
                    t;
                (t = (e = document.querySelector('meta[name="htmx-config"]')) ? function(e) {
                    try {
                        return JSON.parse(e)
                    } catch (e) {
                    ...
                    var t
                }(e.content) : null) && (p.config = c(p.config, t)),
    ...
    function P(e) {
        var t = function(e) {
            var t = e;
            if (0 === t.indexOf("/")) {
                var n = window.location.hostname + (window.location.port ? ":" + window.location.port : "");
                "https:" === window.location.protocol ? t = "wss://" + n + t : "http:" === window.location.protocol && (t = "ws://" + n + t)
            }
            return t
        }(e.evaluate());
    ...
    return function(e) {
        e.addCommand("settle", function(e, t, n) {
            if (n.matchToken("settle")) {
                if (e.commandBoundary(n.currentToken()))
                    r = e.requireElement("implicitMeTarget", n);
                else
                    var r = e.requireElement("expression", n);
                var o = {
                    type: "settleCmd",
                    ...
                    op: function(e, n) {
                        ...
                        return n.addEventListener("transitionstart", function() {
                            a = !0
                        }, {
                            once: !0
                        }), setTimeout(function() {
                            a || i(t.findNext(o, e))
                        }, 500), n.addEventListener("transitionend", function() {
                            i(t.findNext(o, e))
                        }, {
                            once: !0
                        }), u
        ...
        e.addCommand("add", function(e, t, n) {
            if (n.matchToken("add")) {
                var r = e.parseElement("classRef", n),
                    ...
                    i = null;
                if (null == r)
                    null == (o = e.parseElement("attributeRef", n)) && null == (i = e.parseElement("styleLiteral", n)) && e.raiseParseError(n, "Expected either a class reference or attribute expression");
                else
                    for (var a = [r]; r = e.parseElement("classRef", n);)
                        a.push(r);
                if (n.matchToken("to"))
                    var u = e.requireElement("expression", n);
                else
                    u = e.requireElement("implicitMeTarget", n);
                if (n.matchToken("when")) {
                    i && e.raiseParseError(n, "Only class and properties are supported with a when clause");
                    var s = e.requireElement("expression", n)
                }
                return a ? {
                    classRefs: a,
                    to: u,
                    args: [u, a],
                    op: function(e, n, r) {
                        return t.nullCheck(n, u), t.forEach(r, function(r) {
                            t.implicitLoop(n, function(n) {
                                s ? (e.result = n, t.evaluateNoPromise(s, e) ? n instanceof Element && n.classList.add(r.className) : n instanceof Element && n.classList.remove(r.className), e.result = null) : n instanceof Element && n.classList.add(r.className)
                            })
                        }), t.findNext(this, e)
                    }
                } : o ? {
                    ...
                    args: [u],
                    op: function(e, n, r) {
                        return t.nullCheck(n, u), t.implicitLoop(n, function(n) {
                            s ? (e.result = n, t.evaluateNoPromise(s, e) ? n.setAttribute(o.name, o.value) : n.removeAttribute(o.name), e.result = null) : n.setAttribute(o.name, o.value)
                        }), t.findNext(this, e)
                    },
                    execute: function(e) {
                        return t.unifiedExec(this, e)
                    ...
                    args: [u, i],
                    op: function(e, n, r) {
                        return t.nullCheck(n, u), t.implicitLoop(n, function(e) {
                            e.style.cssText += r
                        }), t.findNext(this, e)
                    },
                    execute: function(e) {
        ...
        e.addCommand("remove", function(e, t, n) {
            if (n.matchToken("remove")) {
                var r = e.parseElement("classRef", n),
                    ...
                    i = null;
                if (null == r)
                    null == (o = e.parseElement("attributeRef", n)) && null == (i = e.parseElement("expression", n)) && e.raiseParseError(n, "Expected either a class reference, attribute expression or value expression");
                else
                    for (var a = [r]; r = e.parseElement("classRef", n);)
                        a.push(r);
                if (n.matchToken("from"))
                ...
                return i ? {
                    ...
                    args: [i],
                    op: function(e, n) {
                        return t.nullCheck(n, i), t.implicitLoop(n, function(e) {
                    ...
                    args: [a, u],
                    op: function(e, n, r) {
                        return t.nullCheck(r, u), n ? t.forEach(n, function(e) {
                            t.implicitLoop(r, function(t) {
        ...
        e.addCommand("toggle", function(e, t, n) {
            if (n.matchToken("toggle")) {
                if (n.matchAnyToken("the", "my"), "STYLE_REF" === n.currentToken().type) {
                    ...
                    var f = null;
                    if (null == l)
                        null == (f = e.parseElement("attributeRef", n)) && e.raiseParseError(n, "Expected either a class reference or attribute expression");
                    else
                        for (var m = [l]; l = e.parseElement("classRef", n);)
                            m.push(l)
                }
                if (!0 !== i && (u = n.matchToken("on") ? e.requireElement("expression", n) : e.requireElement("implicitMeTarget", n)), n.matchToken("for"))
                    var p = e.requireElement("expression", n);
                else if (n.matchToken("until")) {
                    var d = e.requireElement("dotOrColonPath", n, "Expected event name");
                    if (n.matchToken("from"))
                        var h = e.requireElement("expression", n)
                }
                var v = {
                    classRef: l,
                    classRef2: c,
                    ...
                    toggle: function(e, n, r, o) {
                        t.nullCheck(e, u),
                        i ? t.implicitLoop(e, function(e) {
                            a("toggle", e)
                        }) : s ? t.implicitLoop(e, function(e) {
                            e.classList.contains(n.className) ? (e.classList.remove(n.className), e.classList.add(r.className)) : (e.classList.add(n.className), e.classList.remove(r.className))
                        }) : o ? t.forEach(o, function(n) {
                    ...
                    op: function(e, n, r, o, i, a, u, s) {
                        return r ? new Promise(function(o) {
                            ...
                            (i || e.me).addEventListener(o, function() {
                                v.toggle(n, a, u, s),
                                r(t.findNext(v, e))
                            }, {
                                once: !0
        ...
        var t = {
                display: function(n, r, o) {
                    if (o)
                        ...
                        null == i.originalDisplay && (i.originalDisplay = r.style.display),
                        r.style.display = "none"
                    } else {
                        var a = e.internals.runtime.getInternalData(r);
                        a.originalDisplay && "none" !== a.originalDisplay ? r.style.display = a.originalDisplay : r.style.removeProperty("display")
                    }
                },
                visibility: function(e, n, r) {
                    r ? n.style.visibility = r : "toggle" === e ? "hidden" === getComputedStyle(n).visibility ? t.visibility("show", n, r) : t.visibility("hide", n, r) : n.style.visibility = "hide" === e ? "hidden" : "visible"
                },
                opacity: function(e, n, r) {
                    r ? n.style.opacity = r : "toggle" === e ? "0" === getComputedStyle(n).opacity ? t.opacity("show", n, r) : t.opacity("hide", n, r) : n.style.opacity = "hide" === e ? "0" : "1"
                }
            },
            n = function(e, t, n) {
                var r = n.currentToken();
                return "when" === r.value || "with" === r.value || e.commandBoundary(r) ? e.parseElement("implicitMeTarget", n) : e.parseElement("expression", n)
            },
            r = function(n, r, o) {
        ...
        function o(t, n, r, o) {
            ...
            if (i instanceof Element || i instanceof HTMLDocument) {
                ...
                if (null == r)
                    throw "Don't know how to put a value into " + typeof n;
                t.setSymbol(r, n, null, o)
            }
        }
        function i(e, t, n) {
            var r;
            if (n.matchToken("the") || n.matchToken("element") || n.matchToken("elements") || "CLASS_REF" === n.currentToken().type || "ID_REF" === n.currentToken().type || n.currentToken().op && "<" === n.currentToken().value) {
                ...
                n.matchToken("my") || n.matchToken("me"),
                r = e.parseElement("implicitMeTarget", n);
            return r
        }
        e.addCommand("hide", function(e, t, o) {
            if (o.matchToken("hide")) {
                var i = n(e, 0, o),
                    a = null;
                o.matchToken("with") && 0 === (a = o.requireTokenType("IDENTIFIER", "STYLE_REF").value).indexOf("*") && (a = a.substr(1));
                var u = r(e, o, a);
                return {
                    target: i,
                    args: [i],
        ...
        e.addCommand("show", function(e, t, o) {
            if (o.matchToken("show")) {
                ...
                if (o.matchToken("when"))
                    var l = e.requireElement("expression", o);
                var c = r(e, o, a);
                return {
                    target: i,
                    when: l,
                    args: [i],
                    op: function(e, n) {
                        return t.nullCheck(n, i), t.implicitLoop(n, function(n) {
                            l ? (e.result = n, t.evaluateNoPromise(l, e) ? c("show", n, u) : c("hide", n), e.result = null) : c("show", n, u)
                        }), t.findNext(this, e)
                    }
                }
            }
        ...
        e.addCommand("take", function(e, t, n) {
            if (n.matchToken("take")) {
                ...
                if (n.matchToken("for"))
                    ...
                    i = e.requireElement("implicitMeTarget", n);
                return {
                    classRef: r,
                    from: o,
                    forElt: i,
                    ...
                    op: function(e, n, r, a) {
                        ...
                        t.nullCheck(a, i);
                        var u = n.className;
                        return t.implicitLoop(r, function(e) {
        ...
        e.addCommand("put", function(e, t, n) {
            if (n.matchToken("put")) {
                ...
                null == i && n.matchToken("at") && (n.matchToken("the"), i = n.matchAnyToken("start", "end"), n.requireToken("of")),
                null == i && e.raiseParseError(n, "Expected one of 'into', 'before', 'at start of', 'at end of', 'after'");
                var a = e.requireElement("expression", n),
                    u = i.value,
                    s = !1,
                    l = !1,
                    c = null,
                    f = null;
                if ("arrayIndex" === a.type && "into" === u)
                    s = !0,
                    f = a.prop,
                    c = a.root;
                else if (a.prop && a.root && "into" === u)
                    f = a.prop.value,
                    c = a.root;
                else if ("symbol" === a.type && "into" === u)
                    l = !0,
                    f = a.name;
                else if ("attributeRef" === a.type && "into" === u) {
                    var m = !0;
                    f = a.name,
                    c = e.requireElement("implicitMeTarget", n)
                } else if ("styleRef" === a.type && "into" === u) {
                    var p = !0;
                    f = a.name,
                    c = e.requireElement("implicitMeTarget", n)
                } else
                    a.attribute && "into" === u ? (m = "attributeRef" === a.attribute.type, p = "styleRef" === a.attribute.type, f = a.attribute.name, c = a.root) : c = a;
                var d = {
                    target: a,
                    operation: u,
                    symbolWrite: l,
                    ...
                    op: function(e, n, r, i) {
                        if (l)
                            o(t, e, r, i);
                        else if (t.nullCheck(n, c), "into" === u)
                            m ? t.implicitLoop(n, function(e) {
                                e.setAttribute(r, i)
                            }) : p ? t.implicitLoop(n, function(e) {
                                e.style[r] = i
                            }) : s ? n[r] = i : t.implicitLoop(n, function(e) {
                                o(t, e, r, i)
                            });
                        else {
                            var a = "before" === u ? Element.prototype.before : "after" === u ? Element.prototype.after : "start" === u ? Element.prototype.prepend : Element.prototype.append;
                            t.implicitLoop(n, function(e) {
                                a.call(e, i instanceof Node ? i : t.convertValue(i, "Fragment"))
                            })
                        }
        ...
        e.addCommand("transition", function(t, n, r) {
            if (r.matchToken("transition")) {
                for (var o = i(t, n, r), a = [], u = [], s = [], l = r.currentToken(); !t.commandBoundary(l) && "over" !== l.value && "using" !== l.value;)
                    "STYLE_REF" === r.currentToken().type ? function() {
                    ...
                    l = r.currentToken();
                if (r.matchToken("over"))
                    var c = t.requireElement("expression", r);
                else if (r.matchToken("using"))
                    var f = t.requireElement("expression", r);
                var m = {
                    to: s,
                    args: [o, a, u, s, f, c],
                    op: function(t, r, i, a, u, s, l) {
                        n.nullCheck(r, o);
                        var c = [];
                        return n.implicitLoop(r, function(t) {
                            var r = new Promise(function(r, o) {
                                ...
                                t.addEventListener("transitionstart", function() {
                                    E = !0
                                }, {
                                    once: !0
                                }),
        ...
        e.addLeafExpression("closestExpr", function(e, t, n) {
            if (n.matchToken("closest")) {
                ...
                if (n.matchToken("to"))
                    var u = e.parseElement("expression", n);
                else
                    u = e.parseElement("implicitMeTarget", n);
                var s = {
                    type: "closestExpr",
                    parentSearch: r,
                    expr: a,
                    ...
                    op: function(e, n) {
                        if (null == n)
                            return null;
                        var i = [];
                        return t.implicitLoop(n, function(e) {
                            i.push(r ? e.parentElement ? e.parentElement.closest(o) : null : e.closest(o))
                        }), t.shouldAutoIterate(n) ? i : i[0]
                    },
                    evaluate: function(e) {
                        return t.unifiedEval(this, e)
                    }
        ...
        e.addCommand("go", function(e, t, n) {
            if (n.matchToken("go")) {
                if (n.matchToken("back"))
                    ...
                    if (n.matchToken("in")) {
                        n.requireToken("new"),
                        n.requireToken("window");
                        var a = !0
                    }
                } else {
                    n.matchToken("the");
                    var u = n.matchAnyToken("top", "middle", "bottom"),
                        s = n.matchAnyToken("left", "center", "right");
                    (u || s) && n.requireToken("of"),
                    o = e.requireElement("unaryExpression", n);
                    var l = n.matchAnyOpToken("+", "-");
                    if (l) {
                        n.pushFollow("px");
                        try {
                    ...
                    n.matchToken("px");
                    var f = n.matchAnyToken("smoothly", "instantly"),
                        m = {};
                    u && ("top" === u.value ? m.block = "start" : "bottom" === u.value ? m.block = "end" : "middle" === u.value && (m.block = "center")),
                    s && ("left" === s.value ? m.inline = "start" : "center" === s.value ? m.inline = "center" : "right" === s.value && (m.inline = "end")),
                    f && ("smoothly" === f.value ? m.behavior = "smooth" : "instantly" === f.value && (m.behavior = "instant"))
                }
                var p = {
                    target: o,
                    args: [o, c],
                    op: function(e, n, o) {
                        return r ? window.history.back() : i ? n && (a ? window.open(n) : window.location.href = n) : t.implicitLoop(n, function(e) {
        ...
        e.config.conversions.dynamicResolvers.push(function(t, n) {
            if ("Values" === t || 0 === t.indexOf("Values:")) {
                var r = t.split(":")[1],
                    o = {};
                if ((0, e.internals.runtime.implicitLoop)(n, function(e) {
                    var t = a(e);
                    void 0 === t ? null != e.querySelectorAll && e.querySelectorAll("input,select,textarea").forEach(i) : o[t.name] = t.value
                }), r) {
                    if ("JSON" === r)
            ...
            function i(e) {
                var t = a(e);
                null != t && (null != o[t.name] ? Array.isArray(o[t.name]) && Array.isArray(t.value) && (o[t.name] = [].concat(o[t.name], t.value)) : o[t.name] = t.value)
            }
            function a(e) {
                try {
                    var t = {
                    ...
                    if (null == t.name || null == t.value)
                        return;
                    if ("radio" == e.type && 0 == e.checked)
                        return;
                    if ("checkbox" == e.type && (0 == e.checked ? t.value = void 0 : "string" == typeof t.value && (t.value = [t.value])), "select-multiple" == e.type) {
                        var n = e.querySelectorAll("option[selected]");
                        t.value = [];
                        for (var r = 0; r < n.length; r++)
                            t.value.push(n[r].value)
                    }
                    return t
                } catch (e) {
                    return
        ...
        e.config.conversions.Fragment = function(t) {
            ...
            return e.internals.runtime.implicitLoop(t, function(e) {
        ...
        var t = 0,
            n = "(" + function(e) {
                e.onmessage = function(t) {
                    switch (t.data.type) {
                    case "init":
                        e.importScripts(t.data._hyperscript),
                        e.importScripts.apply(e, t.data.extraScripts);
                        var n = e._hyperscript,
                            r = n.internals.lexer.makeTokensObject(t.data.tokens, [], t.data.source);
                        n.internals.parser.parseElement("hyperscript", r).apply(e, e),
                        postMessage({
                            type: "didInit"
                        });
                        break;
                    case "call":
                        try {
                            var o = e._hyperscript.internals.runtime.getHyperscriptFeatures(e)[t.data.function].apply(e, t.data.args);
                    ...
                    y[e] = function() {
                        ...
                        return new Promise(function(r, o) {
                            ...
                            h.addEventListener("message", function e(t) {
                                t.data.id === i && (h.removeEventListener("message", e), "resolve" === t.data.type ? r(t.data.value) : o(t.data.error))
                            }),
                            v.then(function() {
                                h.postMessage({
                                    type: "call",
        ...
        e.addFeature("socket", function(e, n, r) {
            if (r.matchToken("socket")) {
                var o = e.requireElement("dotOrColonPath", r).evaluate().split("."),
                    ...
                    s = 1e4;
                if (r.matchToken("with") && (r.requireToken("timeout"), s = e.requireElement("expression", r).evaluate()), r.matchToken("on")) {
                    if (r.requireToken("message"), r.matchToken("as")) {
                        r.requireToken("json");
                        var l = !0
                    }
                    for (var f = e.requireElement("commandList", r), m = {
                            type: "implicitReturn",
                            op: function(e) {
                                return n.HALT
                            },
                ...
                var d = P(u),
                    h = function e(n) {
                        return new Proxy({}, {
                            get: function(r, o) {
                                return t.indexOf(o) >= 0 ? null : "noTimeout" === o ? e(-1) : "timeout" === o ? function(t) {
                                    return e(parseInt(t))
                                } : function() {
                                    for (var e = F(), t = [], r = 0; r < arguments.length; r++)
                                        t.push(arguments[r]);
                                    var i = {
                                        iid: e,
                                        function: o,
                ...
                return d.onmessage = function(e) {
                    ...
                    if (r && r.iid && (r.throw ? a[r.iid].reject(r.throw) : a[r.iid].resolve(r.return), delete a[r.iid]), f) {
                        var o = n.makeContext(v, y, v);
                        if (l) {
                            if (!r)
                                throw "Received non-JSON message from socket: " + t;
                            o.message = r,
                            o.result = r
                        } else
                            o.message = t,
        ...
        e.addFeature("eventsource", function(e, t, n) {
            if (n.matchToken("eventsource")) {
                ...
                for (var c = {
                        ...
                        open: function(e) {
                            if (null == e) {
                                if (null == c.eventSource || null == c.eventSource.url)
                                    throw "no url defined for EventSource.";
                                e = c.eventSource.url
                            }
                            if (null != c.eventSource)
                                if (e != c.eventSource.url)
                                    c.eventSource.close();
                                else if (c.eventSource.readyState != EventSource.CLOSED)
                                    return;
                            c.eventSource = new EventSource(e, {
                                withCredentials: u
                            }),
                        ...
                        close: function() {
                            null != c.eventSource && c.eventSource.close(),
                            c.retryCount = 0
                        },
        ...
        e.addCommand("render", function(t, n, r) {
            if (r.matchToken("render")) {
                var o = t.requireElement("expression", r),
                    i = {};
                return r.matchToken("with") && (i = t.parseElement("namedArgumentList", r)), {
                    args: [o, i],
                    op: function(t, r, i) {
                        if (!(r instanceof Element))
                            throw new Error(o.sourceFor() + " is not an element");
                        return t.result = function(t, n) {
                            var r = [];
                            return e.evaluate(t, Object.assign({
                                __ht_template_result: r
                            }, n)), r.join("")
                        }(function(e) {
                            return e.replace(/(?:^|\n)([^@]*)@?/gm, function(e, t) {
                                return "\ncall __ht_template_result.push(`" + (" " + t).replace(/([^\\])\$\{/g, "$1$${escape html ").substring(1) + "`)\n"
                            })
                        }(r.innerHTML), i), n.findNext(this, t)
                    }
                }
            }
        }),
                ...
                return {
                    ...
                    op: function(e, t) {
                        ...
                        if (void 0 === t)
                            return "";
                        if ("html" === r)
                            return String(t).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\x22/g, "&quot;").replace(/\x27/g, "&#039;");
        ...
        t.prototype.break = function(e) {
            var t = this;
            return console.log("=== HDB///_hyperscript/debugger ==="), this.ui(), new Promise(function(n, r) {
                t.bus.addEventListener("continue", function() {
                    if (t.ctx !== e) {
                        for (var r in e)
                            delete e[r];
                    ...
                    delete window.hdb,
                    n(t.runtime.findNext(t.cmd, t.ctx))
                }, {
                    once: !0
                })
            })
        ...
        t.prototype.stepOver = function() {
            ...
            var t = this.cmd && "breakpointCommand" === this.cmd.type ? this.runtime.findNext(this.cmd, this.ctx) : this.runtime.unifiedEval(this.cmd, this.ctx);
            return "implicitReturn" === t.type ? this.stepOut() : t && t.then instanceof Function ? t.then(function(t) {
                e.cmd = t,
                e.bus.dispatchEvent(new Event("step")),
                e.logCommand()
            }) : void (t.halt_flag ? this.bus.dispatchEvent(new Event("continue")) : (this.cmd = t, this.bus.dispatchEvent(new Event("step")), this.logCommand()))
        },
        t.prototype.stepOut = function() {
            if (!this.ctx.meta.caller)
                return this.continueExec();
        ...
        t.prototype.traverse = function(e) {
            var t = [];
            return function e(n) {
                if (t.push(n), "children" in n)
                    for (var r, o = l(n.children); !(r = o()).done;)
                        e(r.value)
            }(e), t
        },
